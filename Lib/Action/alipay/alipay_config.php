...
$partner        = "2088002158260165";       //合作伙伴ID
$security_code  = "asjuiqajq9g6ta7fqqth8ndtej8bwqri";       //安全检验码
$seller_email   = "shangbl@gmail.com";       //卖家支付宝帐户
...
$return_url     = "http://localhost/Return"; //付完款后跳转的页面 要用 http://格式的完整路径
